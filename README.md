<!--
  ...
  Built to survive GitHub's image pipeline:
    ...
    · panels sit in <a name=...> with no href: GitHub links every bare image
      to its own file, and an anchor without an href is the one wrapper its
      sanitizer keeps that is not a link. Only the cards and the notes on
      the board are meant to be clicked.
  ─────────────────────────────────────────────────────────────────────
-->

<a name="hero"><img src="assets/01_hero.svg" width="880" alt="S. Devkrishna — currently working on reinforcement learning, multi-agent systems and emergent behaviour. Animated pixel-art header: a figure sits on open ground below a cherry blossom tree, looking out over a distant city on the horizon. The canopy moves in the wind, petals drift across the frame, the scene relights itself for the time of day, and the number of lit windows in the city tracks recent commit activity."></a>

<a name="rule_who"><img src="assets/02_rule_who.svg" width="880" alt="Section: who"></a>

<a name="identity"><img src="assets/03_identity.svg" width="880" alt="S. Devkrishna, he/him, @Dxv-404. BSc (Hons) Data Science at CHRIST University, Pune Lavasa, 2027. AI intern at TCS; Django developer at BEO Software; data science at NFI SmartFarm. Co-author of Jadoo: a wearable assistive system, CRC Press book chapter, 2024."></a>

<a name="methods"><img src="assets/04_methods.svg" width="880" alt="Methods and where they are demonstrated. Emergent behaviour in G-ONE: evolved recurrent agents rewarded only to forage. Multi-agent RL in crossroads-rl: PPO agents with a six-action space and a one-bit signal. Evolutionary optimisation in stride: 17 configurations, 30 seeds, GA against DE and PSO. Citation retrieval in Arivu: Postgres, OpenAlex and Semantic Scholar. Calibrated classification in APIN: ensemble leaf-disease diagnosis with Grad-CAM, live."></a>

<a name="rule_work"><img src="assets/05_rule_work.svg" width="880" alt="Section: work"></a>
...
<a name="rule_index"><img src="assets/14_rule_index.svg" width="880" alt="Section: index"></a>

<a name="index"><img src="assets/15_index.svg" width="880" alt="Repository index. Agents and emergent behaviour: G-ONE, crossroads-rl, Afwah, stride. Research tooling: Arivu, adr-system. Applied and shipped: APIN (live), ink-education, Sanchari, Yaatra. Earlier: leetcoder, cam-to-ascii."></a>

<p align="center"><a name="ending-a"><img src="assets/16_ending_a.svg" width="32.624%" align="top" alt=""></a><a href="https://dxv-404-apin.hf.space"><img src="assets/16_ending_apin.svg" width="10.638%" align="top" alt="APIN: leaf doctor one photo. Pinned to the board; opens https://dxv-404-apin.hf.space"></a><a href="https://oracleonline.app"><img src="assets/16_ending_oracle.svg" width="11.111%" align="top" alt="ORACLE: a group's decisions. Pinned to the board; opens https://oracleonline.app"></a><a href="https://www.stridewalk.fun"><img src="assets/16_ending_stride.svg" width="10.165%" align="top" alt="STRIDE: evolved walkers. Pinned to the board; opens https://www.stridewalk.fun"></a><a href="https://github.com/Dxv-404/ink-education"><img src="assets/16_ending_ink.svg" width="10.875%" align="top" alt="INK: studying as a game. Pinned to the board; opens https://github.com/Dxv-404/ink-education"></a><a name="ending-b"><img src="assets/16_ending_b.svg" width="24.586%" align="top" alt=""></a></p>
